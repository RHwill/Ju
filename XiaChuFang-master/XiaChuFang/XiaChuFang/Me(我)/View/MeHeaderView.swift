...
class MeHeaderView: UIView {
    ...
    @IBAction func collectionAndOrderAndDiscountAndIntegralAction(sender: UIButton) {
        if let _delegate = delegate {
            _delegate.meHeaderViewCollectAndOrderAndDiscountAndIntegralActions(sender: sender)
        }
    ...
    @IBAction func headeButtonAction(sender: UIButton) {
        if sender == worksButton {
            ...
            worksButton.setTitleColor(UIColor.red, for: UIControlState.normal)
            ...
            menuButton.setTitleColor(UIColor.red, for: UIControlState.normal)
            worksButton.setTitleColor(UIColor.black, for: UIControlState.normal)
        }
        
        if let _delegate = delegate {
            _delegate.meHeaderViewWorksBtnAndMenuBtnAction(sender: sender)
        }
    }
    ...
    override func awakeFromNib() {
        ...
        self.headerImg.image = UIImage(imageLiteralResourceName: "kid.jpg")
    }
